...
function CardSkeleton() {
    return (
        <div className='col-span-4 space-y-4 lg:col-span-1'>
            <div className={`relative h-[167px] rounded-xl bg-neutral-200 dark:bg-neutral-500 ${shimmer}`} />

            <div className='h-4 w-full rounded-lg bg-neutral-200 dark:bg-neutral-500' />
            <div className='h-6 w-1/3 rounded-lg bg-neutral-200 dark:bg-neutral-500' />
        </div>
    );
}
...
export function CardsSkeleton({ className, columns, count }: CardSkeletonProps) {
    return (
        <div className={`mt-6 grid grid-cols-1 gap-x-6 gap-y-10 md:grid-cols-2 lg:grid-cols-${columns || 3}   xl:gap-x-8 ${className}`}>
